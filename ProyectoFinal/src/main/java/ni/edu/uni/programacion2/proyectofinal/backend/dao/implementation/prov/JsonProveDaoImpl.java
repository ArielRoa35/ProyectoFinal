...
import ni.edu.uni.programacion2.proyectofinal.backend.dao.prov.ProveedoresDao;
 ...
 * @author LENOVO 17
 */
public class JsonProveDaoImpl extends RandomTemplate implements ProveedoresDao{        
    private final int SIZE = 800;    
    private Gson gson;    
    
    public JsonProveDaoImpl() throws FileNotFoundException {
    ...
    @Override
    public void create(Proveedor pr) throws IOException {
        ...
        getCustomRandom().getRafD().writeUTF(gson.toJson(pr));
        
        long posH = 8 + (n*8);
        getCustomRandom().getRafH().seek(posH);
        
        getCustomRandom().getRafH().writeInt(k);
        getCustomRandom().getRafH().writeInt(pr.getServicio());
    ...
    @Override
    public int update(Proveedor pr) throws IOException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public boolean delete(Proveedor pr) throws IOException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public Collection<Proveedor> getAll() throws IOException {
        ...
        for(int i = 0; i < n; i++){
            ...
            getCustomRandom().getRafD().seek(posD);
            pr = gson.fromJson(getCustomRandom().getRafD().readUTF(), Proveedor.class);
